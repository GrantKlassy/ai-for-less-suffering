...
{[peaceful protest](https://en.wikipedia.org/wiki/Nonviolent_resistance), [art piece](https://en.wikipedia.org/wiki/Art), [cryptographic exercise](https://en.wikipedia.org/wiki/Cryptography), [experiment](https://en.wikipedia.org/wiki/Experiment), [piece of journalism](https://en.wikipedia.org/wiki/Journalism), [healing tool](https://en.wikipedia.org/wiki/Mental_health)}

--- using Anthropic's `claude` product.
...
![funny9b](assets/evidence/funny9b.png)
